...
class SharedResources {
    ...
    public static void incrementContextSwitch() {
        ...
        // Added lock to protect contextSwitchCount variable
        countersLock.lock();
        try {
            contextSwitchCount++;
        } finally {
    ...
    public static void incrementCompletedProcess() {
        // TODO: Protect this critical section with a lock
        // Added lock to protect completedProcessCount variable
        countersLock.lock();
        try {
    ...
    public static void addWaitingTime(long time) {
        // TODO: Protect this critical section with a lock
        // Added lock to protect totalWaitingTime variable
        countersLock.lock();
        try {
    ...
    public static void logExecution(String message) {
        ...
        // Added lock to protect the ArrayList from ConcurrentModificationException
        logLock.lock();
        try {
